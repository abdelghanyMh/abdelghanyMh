...
<p align="center">
  <samp>I build <b>backend-heavy systems &amp; AI-assisted tools</b> — RAG &amp; LLM apps · microservices · mobile</samp>
</p>
...
- ⚙️ I build **backend-heavy systems and AI-assisted tools** — LLM apps, microservices & mobile
- 🧠 Currently going deep on **RAG & LLM engineering**, **Python** & **Spring Boot**
...
- **🧠 Document-Intelligence RAG Platform** *(professional work)* — built **RAG** over enterprise documents with **hybrid semantic + keyword retrieval** and **multi-LLM** answer generation (OpenAI · Anthropic · local models) · *Python · FastAPI · pgvector*
- **📱 Rahma** — cross-platform pharmacy app · *Expo · React Native · TypeScript · NativeWind · TanStack Query*
- **🧬 Medical Cases API** — secure clinical-case sharing with **semantic search over a vector database** · *Express · Mongoose · Pug*
- **🛒 React E-Commerce** — furniture shop with auth & payments · *React · Auth0 · Stripe* · **[live ↗](https://react-e-commerce-v2.netlify.app/)**
